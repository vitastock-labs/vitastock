...
export function ResetPasswordCompleteEmail(props: ResetPasswordCompleteEmailProps) {
	...
	return (
		<BaseLayout preview="Your password has been successfully reset">
			...
			<Heading
				className="mb-4 text-center text-2xl font-semibold tracking-tight text-vitastock-primary-main"
			>
				Password Reset Successful
			</Heading>

			<Text className="mb-8 text-center text-base/relaxed text-slate-600">
				Hello <span className="font-semibold text-vitastock-primary-darker">{name}</span>, your password
			...
			<Section className="rounded-lg bg-slate-50 px-6 py-5">
				<Text className="mb-2 text-sm font-semibold text-vitastock-primary-darker">
					Security Reminder
				</Text>
			...
			<Text className="mt-8 mb-0 text-center text-sm/relaxed text-slate-500">
				Need help? Visit our{" "}
